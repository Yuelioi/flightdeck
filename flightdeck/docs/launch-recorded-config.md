---
status: active
when_to_read: 想理解 flightdeck 为何强制 git+runtime、配置为何记进 rules.md frontmatter、或改动 launch 探测 / runtime 调度 / agents_md 字段语义之前
when_to_update: 改了记录式配置 schema（新增/删字段）、晋升判据、稳态优先级、runtime 失效行为、或 launch 拒绝路径时
applies_to: [skills/preflight/protocol.md, skills/preflight/templates.md, skills/preflight/folder-semantics.md, skills/preflight/exit-ritual.md, skills/launch/SKILL.md, skills/landing/SKILL.md, skills/status/SKILL.md, skills/new/SKILL.md, skills/walkaround/SKILL.md, skills/emit-agents-md/SKILL.md, scripts/flightdeck_index.py, scaffolds/full/flightdeck/rules.md]
last_updated: 2026-06-19
summary: flightdeck 把「运行时推断 / 处处兜底」换成「launch 一次性记录 / 强制单条线」——配置记进 rules.md frontmatter（runtime/agents_md，runtime 直读），强制 git + 一个脚本运行时（uv/python/node），删 no-git 分支与手写 markdown 兜底
---
