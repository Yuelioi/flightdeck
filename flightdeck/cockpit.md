...
3. **机械层脚本化 rollout** [plans/2026-06-03-scriptable-mechanical-layer-rollout.md](plans/2026-06-03-scriptable-mechanical-layer-rollout.md)：INDEX-regen 接进 landing/walkaround/status（双轨 fallback）+ rules `scripts:` 开关 + 版本钉死 guard；后续 walkaround lint。
