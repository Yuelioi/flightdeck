...
3. **token-reduction 余下批次** [specs/2026-06-03-token-reduction-design.md](specs/2026-06-03-token-reduction-design.md)：Tier 2 跨文件去重、templates、walkaround(待脚本 lint 子命令)、A1 拆 migration / A3 git heuristic / A4 拆 protocol（preflight 整改的 B/C 已全部完成，仅余这些减重项）。
