---
status: active
when_to_read: before adding a markdown link (or relative path) inside any skills/ prose — SKILL.md / protocol.md / exit-ritual.md / templates.md / folder-semantics.md
