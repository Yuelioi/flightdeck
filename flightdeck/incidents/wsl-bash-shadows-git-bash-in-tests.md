---
status: active
when_to_read: 跑 scripts/tests/test_hooks.py 或任何经 bash 调 hooks/ 脚本的测试失败 returncode=127 时
applies_to: [scripts/tests/test_hooks.py, hooks, bash, windows, wsl, PATH]
